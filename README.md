...
Earl Grey v6.0.1 contains small bug fixes to verify installed RepeatMasker Libraries correctly.
...
```
docker run -it -v `pwd`/host_data/:/data/ quay.io/biocontainers/earlgrey:6.0.1--h4ac6f70_0
```
